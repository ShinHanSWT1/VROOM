...
<body>
    ...
    <script>
        ...
        const mockTasks = [
            { icon: '📦', badge: '배달', time: '5분 전 · 0.8km', title: '스벅 자허블 픽업 해주세요', author: '김민수', views: '234', location: '강남구 역삼동', price: '4,000원' },
            { icon: '🧹', badge: '청소', time: '10분 전 · 1.2km', title: '집 청소 도와주실 분', author: '이영희', views: '156', location: '서초구 서초동', price: '15,000원' },
            { icon: '🔧', badge: '설치/조립', time: '15분 전 · 0.5km', title: '책장 조립 부탁드립니다', author: '박준호', views: '89', location: '송파구 잠실동', price: '8,000원' },
            { icon: '🐕', badge: '반려동물', time: '20분 전 · 1.5km', title: '강아지 산책 시켜주세요', author: '최지현', views: '312', location: '강동구 천호동', price: '6,000원' },
            { icon: '📝', badge: '줄서기', time: '25분 전 · 2.1km', title: '토요쿠 대기줄 서주세요', author: '정수진', views: '445', location: '마포구 합정동', price: '20,000원' },
            { icon: '🛍️', badge: '배달', time: '30분 전 · 0.9km', title: '편의점 야식 배달 부탁해요', author: '강동욱', views: '178', location: '영등포구 여의도동', price: '3,500원' },
            { icon: '🏠', badge: '기타', time: '35분 전 · 1.8km', title: '바퀴벌레 잡아주세요', author: '윤서연', views: '267', location: '송파구 문정동', price: '10,000원' },
            { icon: '🚗', badge: '배달', time: '40분 전 · 0.7km', title: '마트 장보기 대행', author: '한민지', views: '523', location: '강남구 대치동', price: '7,000원' },
            { icon: '📦', badge: '배달', time: '45분 전 · 1.1km', title: '택배 픽업 부탁합니다', author: '임재현', views: '198', location: '서초구 반포동', price: '5,000원' },
            { icon: '🧹', badge: '청소', time: '50분 전 · 1.4km', title: '원룸 청소 도와주세요', author: '오유진', views: '345', location: '강동구 암사동', price: '12,000원' },
            { icon: '🔧', badge: '설치/조립', time: '55분 전 · 0.6km', title: '선반 설치 도와주실 분', author: '송민석', views: '127', location: '송파구 석촌동', price: '6,500원' },
            { icon: '🐕', badge: '반려동물', time: '1시간 전 · 1.9km', title: '고양이 돌봄 부탁해요', author: '백지우', views: '289', location: '마포구 상암동', price: '8,000원' },
            { icon: '📝', badge: '줄서기', time: '1시간 전 · 2.3km', title: '병원 예약 대기 부탁합니다', author: '허준영', views: '156', location: '영등포구 당산동', price: '15,000원' },
            { icon: '🛍️', badge: '배달', time: '1시간 전 · 0.8km', title: '카페 음료 픽업해주세요', author: '남궁현', views: '412', location: '강남구 논현동', price: '4,500원' },
            { icon: '🏠', badge: '기타', time: '1시간 전 · 1.6km', title: '전구 교체 도와주세요', author: '선우진', views: '234', location: '서초구 방배동', price: '5,500원' },
            { icon: '🚗', badge: '배달', time: '2시간 전 · 1.0km', title: '꽃배달 대행 부탁해요', author: '황보라', views: '367', location: '송파구 가락동', price: '6,000원' },
            { icon: '📦', badge: '배달', time: '2시간 전 · 1.3km', title: '서류 전달 부탁합니다', author: '제갈성', views: '178', location: '강동구 길동', price: '7,500원' },
            { icon: '🧹', badge: '청소', time: '2시간 전 · 0.9km', title: '베란다 청소 도와주세요', author: '사공민', views: '245', location: '마포구 연남동', price: '9,000원' },
            { icon: '🔧', badge: '설치/조립', time: '2시간 전 · 1.7km', title: '커튼 설치 도와주실 분', author: '독고준', views: '156', location: '영등포구 신길동', price: '8,500원' },
            { icon: '🐕', badge: '반려동물', time: '3시간 전 · 2.0km', title: '햄스터 돌봄 부탁해요', author: '선우아', views: '298', location: '강남구 삼성동', price: '5,000원' }
        ];

        let currentPage = 1;
        const tasksPerPage = 20; // 보여줄 개수
