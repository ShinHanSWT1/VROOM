...
<c:set var="pageTitle" value="부름 페이 - 부름이 마이 페이지" scope="request"/>
...
<div class="mypage-layout">
    ...
    <main class="mypage-content">
        <h3 class="page-title">부름 페이</h3>

        <!-- Pay Summary Cards (부름이 전용) -->
        <div class="pay-summary-grid">
            <div class="pay-summary-card">
                <div class="pay-summary-label">정산 대기 금액</div>
                <div class="pay-summary-value" id="settlementWaiting">-</div>
                <div class="pay-summary-desc">매칭 후 정산 전 (진행중)</div>
            </div>
            <div class="pay-summary-card">
                <div class="pay-summary-label">수령 예정 금액</div>
                <div class="pay-summary-value" id="expectedAmount">-</div>
                <div class="pay-summary-desc">완료 후 정산 대기중</div>
            </div>
            <div class="pay-summary-card">
                <div class="pay-summary-label">이번 달 정산 수익</div>
                <div class="pay-summary-value" id="thisMonthSettled">-</div>
                <div class="pay-summary-desc">정산 완료된 금액</div>
            </div>
        </div>

        <!-- Pay Info Card (사용자 vroomPay와 동일) -->
        <div class="pay-info-card">
            ...
            <div class="temp-container">
                ...
                <div class="temp-bar">
                    <div class="temp-fill" style="width: ${profile.mannerTemp != null ? profile.mannerTemp : 36.5}%;"></div>
                </div>
                <span class="temp-value">${profile.mannerTemp != null ? profile.mannerTemp : 36.5}℃</span>
            </div>
        ...
        <!-- Transaction History Section (사용자 vroomPay와 동일) -->
...
<%-- Modal Windows (사용자 vroomPay와 동일) --%>
